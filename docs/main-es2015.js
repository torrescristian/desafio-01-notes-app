...
let CreateButtonComponent = class CreateButtonComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let EndEditButtonComponent = class EndEditButtonComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let HeaderComponent = class HeaderComponent {
    ...
    createNote() {
        ...
        this.store.dispatch(Object(src_app_store_notes_actions__WEBPACK_IMPORTED_MODULE_3__["ADD"])({ note }));
...
let ListItemComponent = class ListItemComponent {
    ...
    handleEndEdit() {
        ...
        this.store.dispatch(src_app_store_notes_actions__WEBPACK_IMPORTED_MODULE_3__["UPDATE"]({
            note: Object.assign({}, this.note, { title: this.titleTxt.value, content: this.tempContent }),
        }));
    }
...
const ADD = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Notes] add note', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
const REMOVE = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Notes] remove note', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
const UPDATE = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Notes] update note', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
